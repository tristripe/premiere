!function (e) {
  function t(t) {
    for (var r, i, c = t[0], l = t[1], s = t[2], p = 0, d = []; p < c.length; p++) i = c[p], Object.prototype.hasOwnProperty.call(o, i) && o[i] && d.push(o[i][0]), o[i] = 0;
  ...
  if (o && (o = new r.a(o, {
    ...
    var s = document.querySelectorAll(".ampm-text-slide__button--first"),
      u = document.querySelectorAll(".ampm-text-slide__button--second"),
      p = document.querySelectorAll(".ampm-text-slide__button--three"), d = ["1", "2", "3"];
    a = new r.a(a, {
      pagination: {
    ...
    for (var f = 0; f < l.length; f++) l[f].addEventListener("click", (function () {
  ...
  if (i && (i = new r.a(i, {
    slidesPerView: 3,
    spaceBetween: 5
  })), c) for (var _ = document.querySelectorAll(".ampm-tabs__button"), b = function (e) {
    var t = c[e];
    t = new r.a(t, {slidesPerView: "auto", spaceBetween: 30}), _[e].addEventListener("click", (function (n) {
      for (var r = 0; r < c.length; r++) {
        c[r].classList.remove("ampm-tabs__container--active")
      }
      c[e].classList.add("ampm-tabs__container--active"), t.update()
    }))
  }, v = 0; v < c.length; v++) b(v);
  n(0)
}]);
